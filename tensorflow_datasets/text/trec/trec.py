...
# coding=utf-8
# Copyright 2020 The HuggingFace NLP Authors and
...
class Trec(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self):
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict(
            {
                "label-coarse": tfds.core.ClassLabel(names=_COARSE_LABELS),
                "label-fine": tfds.core.ClassLabel(names=_FINE_LABELS),
  ...
  def _split_generators(self, dl_manager):
    ...
    # dl_manager is a tfds.core.download.DownloadManager that can be used to
